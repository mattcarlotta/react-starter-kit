...
import { homeIconContainer, homeIconStyle } from "./styles.scss";

const HomeIcon = () => (
  <span className={homeIconContainer}>
    <svg height="25" width="25" className={homeIconStyle} viewBox="0 0 20 20">
      <path
        fill="none"
