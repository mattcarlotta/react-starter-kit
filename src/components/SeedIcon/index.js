...
import { seedIconContainer, seedIconStyle } from "./styles.scss";

const SeedIcon = () => (
  <span className={seedIconContainer}>
    <svg height="25" width="25" className={seedIconStyle} viewBox="0 0 20 20">
      <path
        fill="none"
